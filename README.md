...
**Domain:** <code>yarasoolallah.it.com</code>
...
هذا ليس مشروع صفحات متفرقة. إنه محاولة لبناء **رحلة معرفة مترابطة** يرى فيها الزائر السيرة في سياقها الزمني والجغرافي والإنساني، ويربط الحدث بالقرآن والسنة والأشخاص والأماكن والمصادر، ثم يفتح الدليل بنفسه.
...
**المبدأ:** لا نطلب من الإنسان أن يصدق واجهة جميلة. نعطيه طريقًا واضحًا إلى **المصدر**.
...
**الحقيقة لا تتغير بين المستويات. الذي يتغير هو عمق العرض وأدوات الدراسة.**

## ✦ «شاهد الدليل»

طبقة الأدلة مصممة لاستيعاب اسم المصدر، المؤلف أو المصنف، الكتاب والباب، رقم السجل أو الحديث، الإصدار والترجمة، الرابط، بيانات المصدر، حالة المراجعة التحريرية، والتنبيه حين يكون التاريخ أو المكان تقريبيًا أو محل اختلاف.

**لا نسب ثقة وهمية. لا مراجع مخترعة. لا مصادر مصنوعة من أجل ملء الفراغ.**

## 📚 مكتبة الرفوف

المكتبة ليست متجرًا. التصور النهائي يجمع:

### ① الرفوف البصرية
للاكتشاف والتصفح والشعور بأن المستخدم دخل مكتبة معرفة حقيقية.

### ② الكتالوج
للبحث والفلاتر والوصول بلوحة المفاتيح وقارئات الشاشة.

### ③ مكتب القراءة
للقراءة المركزة، الحفظ، الملاحظات، التقدم، الصوت والمصادر.

الكتاب ليس «كارتًا». الكتاب **كيان معرفي** له مؤلف ومصدر وطبعة ولغة وحالة توفر وحقوق.
...
لكن من غير تحويل العبادة إلى لعبة نقاط. لا مقياس تقوى، ولا ضغط streak، ولا تقييم ديني للإنسان، ولا حكم شرعي مولّد من الذكاء الاصطناعي.

التقدم هنا يعني: **استمرار التعلم**.

## 👨‍👩‍👧‍👦 للأطفال والعائلة

التجربة مخططة حول مواقف موثقة، خرائط وأماكن، أسئلة فهم، مسارات مناسبة للعمر، رقابة أسرية، وفيديوهات ومصادر آمنة.
...
<code>آية</code> • <code>ترجمة</code> • <code>تفسير</code> • <code>حديث</code> • <code>حدث سيرة</code> • <code>شخص</code> • <code>مكان</code> • <code>كتاب</code> • <code>باب</code> • <code>موضوع</code> • <code>محتوى أطفال</code> • <code>مصدر</code>
...
لن نستخدم كلمات <code>Production Ready</code> أو <code>Complete</code> أو <code>100%</code> إلا عندما توجد أدلة فعلية من:

**TypeScript • Build • Tests • Runtime • Browser QA • CI • Git SHA**

الهدف ليس أن يبدو المشروع مكتملًا قبل أوانه. الهدف أن يكون **ما نعلنه صحيحًا**.
...
> **هذه خارطة طريق وليست ادعاءً بأن العناصر أعلاه مكتملة.**
...
يؤمن صادق بأن التكنولوجيا الحقيقية لا تُقاس فقط بعدد الأسطر البرمجية أو قوة الأنظمة، بل بقدرتها على **حل مشكلات حقيقية، تسهيل حياة الناس، مساعدة أصحاب الأعمال، وتوفير أدوات تجعل الإنسان أكثر قدرة وإنتاجية واستقلالًا**.

### رؤية KNOUX

تهدف **KNOUX** إلى بناء منظومة تقنية متكاملة تجمع بين تطوير البرمجيات والأنظمة الذكية، تطبيقات Windows وسطح المكتب، تطبيقات الهواتف المحمولة، منصات الويب والسحابة، الذكاء الاصطناعي والأتمتة، أنظمة إدارة الشركات، التجارة الإلكترونية والخدمات اللوجستية، أدوات الصيانة، وتجربة المستخدم.

والهدف الأكبر هو بناء منتجات عملية وذكية يمكن استخدامها في الحياة اليومية والعمل والتعليم والإدارة والخدمات المختلفة، وتترك أثرًا حقيقيًا في خدمة الإنسان.

### الخبرة التقنية

**React • TypeScript • Electron • Android • Supabase • PostgreSQL • GitHub • Vercel • PowerShell • AI Integrations • CI/CD • Cloud Systems • UI/UX**

ويركز أسلوب العمل على الانتقال بالمشروعات من الأفكار والنماذج الأولية إلى **منتجات حقيقية قابلة للاستخدام والتوسع والتطوير المستمر**.
...
عند فتح المساهمة العامة ستكون الأولوية للمساهمات التي تحترم الدقة العلمية والتوثيق، جودة الكود والاختبارات، Accessibility، العربية وRTL، الخصوصية والأمان، حقوق الكتب والترجمات والصوتيات، وعدم تقديم محتوى ديني مولّد على أنه مصدر أصلي.
...
<code>yarasoolallah.it.com</code>
